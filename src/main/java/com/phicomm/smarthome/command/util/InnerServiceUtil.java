...
public class InnerServiceUtil {
    private interface Services {
        ...
        static final String SERVICE_SMARTHOME_OTA_UPGRADE = "smarthome-phihome-ota";
    }
    ...
    public static String getSmartHomeOtaUpgradeUrl(EurekaClient discoveryClient, String end) {
        return Holder.instance.getInner(discoveryClient, Services.SERVICE_SMARTHOME_OTA_UPGRADE, end);
    }
}
